...
- Added new methods to `RedisQueuedLocks::Resource`:
  ...
  - `.extract_non_identified_part` - extract the substring from acquirer identifier (or from host identifier) excluding the **identity** part needed for `ZSCAN` command;
### Changed
