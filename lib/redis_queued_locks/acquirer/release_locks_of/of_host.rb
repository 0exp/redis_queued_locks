...
# @api private
# @since 1.13.0
module RedisQueuedLocks::Acquirer::ReleaseLocksOf::OfHost
  # @since 1.13.0
  ...
  class << self
    ...
    def release(
      ...
      rel_key_cnt = remove_locks(redis, host_id, scan_size)
      ...
      run_non_critical do
        instrumenter.notify('redis_queued_locks.release_all_locks_of_host', {
          at: time_at,
          hst_id: host_id,
          rel_time:,
          rel_key_cnt:,
    ...
    # @api private
    # @since 1.13.0
    def remove_locks(redis, host_id, scan_size)
      ...
      redis.with do |rconn|
        ...
        rconn.scan(
          ...
          lock_host_id = rconn.call("HMGET", lock_key, "hst_id")

          if host_id == lock_host_id
